...
function paramSetup() {
	...
	var id = 7;
	curteamname = $('#teamname').val();   // current value for category

	// Now create the URL for the runners query
	// Decide which query to use for the runners list
		
	runnersurl = new String(baseurl + "?id=5&p1="+encodeURIComponent(curteamname));
/*	
...
$(document).ready(function() {
	...
	$('#teamname').focus();   // focus on the surname field
