...
var race_years = new Array("2011","2010","2009","2008","2007","2006","2005","2004");
...
searchtype = new String(Request.QueryString("searchtype")).toString();
if (searchtype == "null" || searchtype == "undefined")
{
	searchtype = new String(Request.Form("searchtype"));
	if (searchtype == "null" || searchtype == "undefined")
		searchtype = new String("C").toString();
}
searchtype=searchtype.toUpperCase();
if (! nosurname )
{
	if (searchtype == "S")
		thesurname = Trim(thesurname+"*");
	if (searchtype == "C")
		thesurname = "*" + Trim(thesurname) + "*";
	if (searchtype == "E")
		thesurname = "*" + Trim(thesurname);
